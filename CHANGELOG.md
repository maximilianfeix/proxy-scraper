...
### Added
- `--serve-refill HOURS`: the running proxy server checks fresh proxies in the background and adds the hits, so it no longer runs dry over days; `compose.yaml` uses it ([#109](../../issues/109))
